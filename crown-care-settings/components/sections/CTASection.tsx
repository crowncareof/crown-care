...
export default function CTASection({ settings = {} }: Props) {
  ...
  const address = settings['company_address'] || 'Nationwide, USA';
          ...
          >
            <div className="bg-navy-gradient rounded-3xl p-8 text-white relative overflow-hidden">
              ...
              <div className="space-y-5">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${phone.replace(/\D/g,'')}`} className="text-white font-medium hover:text-gold-400 transition-colors font-body">
                      {phone}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${email}`} className="text-white font-medium hover:text-gold-400 transition-colors font-body">
                      {email}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white font-medium font-body">{address}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-8 border-t border-white/10">
                ...
                <a
                  href={whatsappLink(undefined, waNum)}
                  target="_blank"
            ...
            <form onSubmit={handleSubmit} className="card-premium p-8 space-y-5">
              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input type="text" name="name" required value={form.name} onChange={handleChange} placeholder="John Smith" className="input-base" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-navy-800 mb-1.5 font-body">Email Address *</label>
                  <input type="email" name="email" required value={form.email} onChange={handleChange} placeholder="john@example.com" className="input-base" />
                </div>
              </div>
              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  <label className="block text-sm font-medium text-navy-800 mb-1.5 font-body">Phone Number</label>
                  <input type="tel" name="phone" value={form.phone} onChange={handleChange} placeholder="(555) 000-0000" className="input-base" />
                </div>
                <div>
